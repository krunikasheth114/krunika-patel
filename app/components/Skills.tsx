...
const skillCategories = [
  {
    title: "Frontend",
    skills:
      "React, Next.js, TypeScript, Tailwind CSS, Redux, Zustand, React Router, React Query",
  },
  {
    title: "Backend",
    skills: "Node.js, Express, REST APIs, Authentication, GraphQL, Prisma, PHP (Laravel)",
  },
  {
    title: "Database",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          {skillCategories.map((cat) => (
            <div
              key={cat.title}
              className="bg-card border border-border rounded-lg p-5 sm:p-6 card-hover hover:border-primary/40"
            >
